...
cd ${ETL_DIR}; mvn -Dlogback.configurationFile=${BIGDATA_DIR}/configuration/logback.xml exec:java -Dexec.mainClass="com.mvdb.etl.actions.InitDB" ; cd ${BIGDATA_DIR}/usage-details
...
cd ${ETL_DIR}; mvn -Dlogback.configurationFile=${BIGDATA_DIR}/configuration/logback.xml exec:java -Dexec.mainClass="com.mvdb.etl.actions.ModifyCustomerData" -Dexec.args="--batchCount 1  --batchSize 1000" ; cd ${BIGDATA_DIR}/usage-details
